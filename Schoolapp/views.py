...
from .models import  Course, Student_detail, tbl_login
...
def Sprofile(request):
    data=Student_detail.objects.filter(email=id)
    context={
        "data":data
    }
...
def SubjectFeedbackBiology(request):
    return render(request, "Student/subject_feedback_biology.html")
