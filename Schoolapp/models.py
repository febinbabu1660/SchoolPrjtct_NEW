...
class Subject(models.Model):
    ...
    Course_name = models.ForeignKey(Course, on_delete=models.CASCADE)
    # class_name = models.ForeignKey(Class_division, on_delete=models.CASCADE)
    # teacher = models.ForeignKey(tbl_login, on_delete=models.CASCADE, limit_choices_to={'type': 'Teacher'})
